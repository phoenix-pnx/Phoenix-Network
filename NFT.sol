...
contract VeLogo {
    string public baseURI = "https://xnft-core.shazam.finance/";
...
contract Ve is IERC721, IERC721Metadata, IVe, Reentrancy {
    ...
    uint256 internal constant MAX_TIME = 2 * 365 * 86400;
    int128 internal constant I_MAX_TIME = 2 * 365 * 86400;
    ...
    string public constant override name = "xSHAZAM";
    string public constant override symbol = "xSHAZAM";
    ...
    constructor(address token_, address controller_, address veLogo_) {
        token = token_;
    ...
    function _tokenURI(
        ...
        return VeLogo(veLogo).tokenURI(_tokenId);
    }
